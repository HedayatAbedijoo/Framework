...
//Source Articel:  http://blogs.msmvps.com/p3net/2016/02/07/documenting-web-apis-with-swagger/

namespace Framework.UI.Core.Swagger
{
  /// <summary>
  ...
  public class ReflectionDocumentationProvider : IDocumentationProvider, IOperationFilter, IModelFilter
  {
    ...
    public void Apply(Schema model, ModelFilterContext context)
    {
      ...
      {
        if (CheckIgnoreDocumentAttr(property, typeof(IgnoreDocumentationAttribute)))
          continue;
    ...
    public bool CheckIgnoreDocumentAttr(PropertyInfo prop, Type attributeType)
    {
